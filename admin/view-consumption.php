<?php
  ...
  if(isset($_GET['view_b'])){
        ...
        if(mysqli_num_rows($runQuery)>  0){
          ...
          $gasCons = $gasCons . '"'. $row['gas_consumption'].'",';
          $waterCons = $waterCons . '"'. $row['water_consumption'] .'",';
          $elecCons = $elecCons . '"'. $row['electricity_consumption'] .'",';
          $fuelCons = $fuelCons . '"'. $row['fuel_consumption'] .'",';
      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="card">
            ...
            <div class="card-body">
              <div class="container"> 
      <h1><?php if(isset($vBuildingName)){echo "Consumption: " .$vBuildingName; }?></h1>       
